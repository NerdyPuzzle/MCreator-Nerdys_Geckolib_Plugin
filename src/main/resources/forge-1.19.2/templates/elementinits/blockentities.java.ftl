...
public class ${JavaModName}BlockEntities {
	...
	<#else>
	public static final RegistryObject<BlockEntityType<${blockentity.getModElement().getName()}TileEntity>> ${blockentity.getModElement().getRegistryNameUpper()} = REGISTRY.register("${blockentity.getModElement().getRegistryName()}",
